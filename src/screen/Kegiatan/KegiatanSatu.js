...
// create a component
const KegiatanSatu = ({navigation}) => {
    return (
        <View style={styles.container}>
            <View style={{ margin: 15 }}>
                <TouchableOpacity onPress={()=>navigation.navigate('Peta Konsep Satu')}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('Materi Pembelajaran Satu')}>
